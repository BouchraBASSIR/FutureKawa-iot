...
MESURES_SAMPLE = [
    {
        ...
        "temperature": 28.5,
        "humidite": 54.0,
        "date_mesure": "2026-06-01T10:00:00",
        "id_capteur": 1
    },
    {
        "id_mesure": 2,
        "temperature": 29.1,
        "humidite": 55.5,
        "date_mesure": "2026-06-01T11:00:00",
        "id_capteur": 1
    },
]
    ...
    "alertes_mesures": [
        {
            ...
            "statut": "non_lue",
            "date_alerte": "2026-06-10T08:00:00"
        },
    ],
    "alertes_lots": [
        {
            "id_alerte_lot": 1,
            "message": "Lot LOT-BR-OLD périmé",
            "id_lot": "LOT-BR-OLD",
            "statut": "non_lue",
            "date_alerte": "2026-06-09T12:00:00"
        },
    ],
}
...
EXPLOITATIONS_SAMPLE = [
    {"id_exploitation": 1, "nom": "Fazenda-A", "id_config": 1}
]
...
async def test_stocks_filter_by_country(mock_fetch):
    ...
    lots = r.json()
    assert len(lots) == 2
    assert all(lot["country_id"] == "bresil" for lot in lots)
...
# ── /api/central/stocks/{country_id}/{lot_id} ────────────────────────────────
...
# ── /api/central/stocks/{country_id}/{lot_id}/mesures ────────────────────────
...
# ── POST /api/central/{country_id}/lots ──────────────────────────────────────
...
async def test_get_alertes_sorted_newest_first(mock_fetch):
    alertes_multi = {
        "alertes_mesures": [
            {
                "id_alerte_mesure": 1,
                "date_alerte": "2026-06-01T08:00:00",
                "statut": "non_lue"
            },
            {
                "id_alerte_mesure": 2,
...
async def test_dashboard_consolidated(mock_fetch):
    mock_fetch.side_effect = make_side_effect({
        ...
        ("equateur", "/stats/dashboard"): {
            **DASHBOARD_SAMPLE,
            "pays": "equateur",
            "total_lots": 5
        },
        ("colombie", "/stats/dashboard"): {
            **DASHBOARD_SAMPLE,
            "pays": "colombie",
            "total_lots": 3
        },
